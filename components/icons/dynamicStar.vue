...
<template>
  <div class="scores flex gap-2">
    <div v-for="(item,index) in 5" @click="rate(index)">
      <svg viewBox="0 0 16 16" width="1em" height="1em" ref="starsFill"
      ...
      <svg viewBox="0 0 16 16" width="1em" height="1em" ref="starsBorder"
           xmlns="http://www.w3.org/2000/svg" fill="currentColor"
