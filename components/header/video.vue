...
<template >
  <div class="navbar navbar-custom bg-transparent  h-fit top-0 z-10 " ref="navbar">
    <div class="container px-3 md:px-0 py-5 mx-auto flex relative z-10 items-center justify-between">
